...
using OSVR.Unity;
using UnityEngine;
using Pose3 = OSVR.ClientKit.Pose3;
using PoseInterface = OSVR.ClientKit.PoseInterface;
    ...
    public void Update() {
      ...
      for ( int i = 0 ; i < count ; i++ ) {
        ...
        handGo.transform.localScale = 
          Vector3.Lerp(Vector3.one*0.75f, Vector3.one*1.75f, handInfo.GrabStrength)*0.01f;
      }
    }
